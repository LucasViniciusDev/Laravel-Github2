<div class="container" id="users-view">
    <div id="users-container" class="row justify-content-between mt-5">
        <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="card mb-3">
                <div class="row no-gutters">
                    <div class="col-md-4">
                        <img src="" class="card-img" alt="avatar">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <a href="#" title="Ver Repositórios">
