<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand header-link" href="{{ route('home') }}">
    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve" height="32" width="32">
        <path style="fill:#fff;" d="M255.968,5.329C114.624,5.329,0,120.401,0,262.353c0,113.536,73.344,209.856,175.104,243.872
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <form id="form-search-user" class="form-inline my-2 my-lg-0">
            <input class="form-control mr-sm-2 input-search" name="user_name" type="search" placeholder="Buscar usuário" aria-label="Search">
        </form>
      </li>
    </ul>
  </div>
