<div class="container" id="repositories-view">
    <div class="row mt-2">
        <button class="btn btn-primary btn-sm" id="repositories-btn-voltar">
            < Voltar
        </button>
    </div>
    <div id="repositories-container" class="row mt-2">
        <div class="col-lg-3 col-md-6 col-sm-12">
            <div style="text-align: center;"><img class="avatar-img" src="#" alt="avatar"></div>
            <h4 style="text-align: center;">USER_LOGIN</h4>
            <div style="text-align: center;">
                <a href="#" title="Abrir no Github" target="_blank">
                ...
                <div class="card mb-3" style="width: 100%;">
                    <div class="row no-gutters">
                        <div class="col-md-8">
                            <div class="card-body">
                                <a href="#" title="Abrir no Github" target="_blank">
                                    <h6 style="color: #0366d6;">REPOSITORY_NAME</h6>
                                </a>
                                <p class="card-text">
                                    <small>REPOSITORY_DESCRIPTION</small>
                                </p>
                                <p class="card-text">
                                ...
                                <p class="card-text">
                                    <span class="mr-2">
                                        <button type="button" class="btn btn-light btn-sm btn-clone" data-https="#" data-ssh="#">Clone</button>
                                    </span>
                                    ...
                                    <span class="mr-2">
                                        ...
                                        <span style="font-size: 10pt;">REPOSITORY_LANGUAGE</span>
                                    </span>
                                    <!-- if repository.language -->
                                    <span class="mr-2">
